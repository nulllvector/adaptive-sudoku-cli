...
def test_skill_score_maps_to_difficulty_bucket():
    ...
    assert difficulty_for_skill(19) == Difficulty.BEGINNER
    assert difficulty_for_skill(20) == Difficulty.EASY
    assert difficulty_for_skill(21) == Difficulty.EASY
    assert difficulty_for_skill(39) == Difficulty.EASY
    assert difficulty_for_skill(40) == Difficulty.MEDIUM
    assert difficulty_for_skill(41) == Difficulty.MEDIUM
    assert difficulty_for_skill(59) == Difficulty.MEDIUM
    assert difficulty_for_skill(60) == Difficulty.HARD
    assert difficulty_for_skill(61) == Difficulty.HARD
    assert difficulty_for_skill(79) == Difficulty.HARD
    assert difficulty_for_skill(80) == Difficulty.EXPERT
